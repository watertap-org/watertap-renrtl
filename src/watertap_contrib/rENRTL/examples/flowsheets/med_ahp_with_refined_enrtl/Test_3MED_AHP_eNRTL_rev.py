...
class TestMED:
    ...
    def create_arcs(self,MED_AHP_eNRTL):
    ...
    @pytest.fixture(scope="function")
    def populate_enrtl_state_vars_gen(self, MED_AHP_eNRTL, base="FpcTP"):  # for AHP loop
        m = MED_AHP_eNRTL
    ...
    @pytest.fixture(scope="function")
    def add_enrtl_method_AHP(self,MED_AHP_eNRTL,populate_enrtl_state_vars_gen):
        m = MED_AHP_eNRTL
        sb_enrtl_gen = m.fs.enrtl_state_gen.properties[0]  # renaming the block

        # Populate eNRTL state block
        populate_enrtl_state_vars_gen
    ...
    @pytest.fixture(scope="function")
    def set_scaling(self,MED_AHP_eNRTL):
        m = MED_AHP_eNRTL
    ...
    @pytest.fixture(scope="function")
    def set_model_inputs(self,set_scaling):
        m = set_scaling
        # Feed
    ...
    @pytest.fixture(scope="function")
    def initialize(self, set_model_inputs, outlvl=idaeslog.NOTSET):
        m = set_model_inputs
    ...
    @pytest.fixture(scope="function")
    def add_bounds(self,MED_AHP_eNRTL):
        m = MED_AHP_eNRTL
    ...
    @pytest.fixture(scope="function")     
    def model_analysis(self,MED_AHP_eNRTL, water_rec=None):
        m = MED_AHP_eNRTL
    ...
    def test_set_model_inputs(self, set_model_inputs):
